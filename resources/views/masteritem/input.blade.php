...
<div class="container">
    <form action="/masteritem/input" method="POST">
        @csrf
    <div class="row">
        <div class="">
        ...
        <div class="">
            ...
            <input type="text" name="namabarang" class="form-control"  placeholder="Masukkan Nama" required  value="{{ old('namabarang') ?? $namabarang ?? '' }}">
        </div>
        <br>
        <div class="">
            <h4 align=left>UM</h4>
